...
function filterArr<T>(arr : T[], predicate : (item : T)=> boolean) : T[]{
...
function getValue<T ,k extends keyof T> (obj : T , key : T): T[k]{
  return obj[key];
}
...
function mapWithId<T>(arr: T[]): { id: number; value: T }[] {
