...
function greet(name : string) : string { // we need explicitly annotate the return value and the funtion value when we are pasing to funtion
  return "Hello, " + name;
}

console.log(greet("soumalya")); // 

const value: string = "Soumalya"; // string


const userAge : number = 23; // need to explicitly annotate the userAge with number
