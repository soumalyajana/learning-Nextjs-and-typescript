...
const userEntity : [string , number] = ['soumalya', 23];
...
/// ✅ TypeScript Practice Set: Array Types & Readonly Arrays

// ----------------------------------------------------
// Q1️⃣ Basic Array Type Declarations
// ----------------------------------------------------
type CityNameType = string[];

const city: CityNameType = ["Kolkata", "Bangalore", "Mumbai", "Pune"];

type SecondTypeDeclaration = Array<string>;

const city1: SecondTypeDeclaration = ["Kolkata", "Bangalore", "Mumbai", "Pune"];
...
// ----------------------------------------------------
const items: (string | number)[] = ["apple", 10, "banana", 25];
...
const readonlyNumbers: readonly number[] = [10, 20, 30, 40];
...
// ----------------------------------------------------
function calculateSum(nums: readonly number[]): number {
  let sum = 0;
  for (const n of nums) {
    sum += n;
  }
...
const readonlyArr: ReadonlyArray<number> = [4, 5, 6];
